<template>
  <!-- 需要缓存的不写noNeedKeep,不需要缓存的写noNeedKeep==true即可 -->
  <div id="app">
    <!-- <router-view v-if="$route.meta.noNeedKeep"></router-view> -->
    <keep-alive>
      <router-view></router-view>
      <!-- <router-view v-if='$route.meta.noNeedKeep==undefined'></router-view> -->
    </keep-alive>
  </div>
</template>
